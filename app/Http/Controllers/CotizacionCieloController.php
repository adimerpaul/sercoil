...
class CotizacionCieloController extends Controller
{
	...
	public function confirma(Request $request){
		...
		$vc->ID_PRO=23; 
		$vc->RES_VC=0; 
		$vc->CANT_VC=$request->cantidad_perimetral_3mts;
		$vc->save();
		...
		$vc->ID_PRO=24; 
		$vc->RES_VC=0; 
		$vc->CANT_VC=$request->cantidad_central_3_66mts;
		$vc->save();
		...
		$vc->ID_PRO=25; 
		$vc->RES_VC=0; 
		$vc->CANT_VC=$request->cantidad_transversal_1_22mts;
		$vc->save();
		...
		$vc->ID_PRO=26; 
		$vc->RES_VC=0; 
		$vc->CANT_VC=$request->cantidad_transversal_0_61mts;
		$vc->save();
